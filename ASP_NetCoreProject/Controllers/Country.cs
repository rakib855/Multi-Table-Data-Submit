...
namespace ASP_NetCoreProject.Controllers
{
    public class Country : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Cities")] Data.Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("ID,Name,Cities")] Data.Country country)
        {
            if (id != country.ID)
            {
                return NotFound();
